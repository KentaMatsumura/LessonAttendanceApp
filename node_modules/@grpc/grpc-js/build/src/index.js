...
const supportedNodeVersions = require('@grpc/grpc-js/package.json').engines.node;
...
const resolver = require("@grpc/grpc-js/build/src/resolver");
const load_balancer = require("@grpc/grpc-js/build/src/load-balancer");
(() => {
